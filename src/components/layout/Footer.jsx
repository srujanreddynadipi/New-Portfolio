...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: Github, href: 'https://github.com/srujanreddynadipi', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/srujanreddynadipi/', label: 'LinkedIn' },
    { icon: Mail, href: 'mailto:srujanreddynadipi@gmail.com', label: 'Email' },
  ]
